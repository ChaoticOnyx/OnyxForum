-- --------------------------------------------------------
-- Хост:                         18.156.98.125
-- Версия сервера:               10.3.18-MariaDB-0+deb10u1 - Debian 10
...
-- Дамп структуры базы данных onyx
CREATE DATABASE IF NOT EXISTS `onyx` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `onyx`;

-- Дамп структуры для таблица onyx.council_suggestions
...
-- Дамп структуры для таблица onyx.council_suggestion_statuses
...
-- Дамп структуры для таблица onyx.council_suggestion_votes
...
-- Дамп структуры для таблица onyx.discord_roles
...
-- Дамп структуры для таблица onyx.discord_users
...
-- Дамп структуры для таблица onyx.discord_user_roles
...
-- Дамп структуры для таблица onyx.donations_types
...
-- Дамп структуры для таблица onyx.issues
...
-- Дамп структуры для таблица onyx.issues_design_approves
...
-- Дамп структуры для таблица onyx.issues_points
...
-- Дамп структуры для таблица onyx.issues_votes
...
-- Дамп структуры для таблица onyx.karma
...
-- Дамп структуры для таблица onyx.message_to_issue
...
-- Дамп структуры для таблица onyx.money_currencies
...
-- Дамп структуры для таблица onyx.money_transactions
...
-- Дамп структуры для таблица onyx.patron_types
...
-- Дамп структуры для таблица onyx.players
...
-- Дамп структуры для таблица onyx.points_transactions
...
-- Дамп структуры для таблица onyx.points_transactions_types
...
-- Дамп структуры для таблица onyx.runtimes
...
-- Дамп структуры для таблица onyx.store_players_items
...
-- Дамп структуры для таблица onyx.tokens
...
-- Дамп структуры для таблица onyx._ARCHIVED_donations
